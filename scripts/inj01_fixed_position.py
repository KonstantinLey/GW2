...
GW170817_injections['psi'] = np.concatenate((np.ones(int(5))*1.16419856771,np.array([0,np.pi/6,np.pi/2,np.pi*2/3,np.pi*5/6])))
#Hold the point fixed with respect to the detectors

time_sid_day = 86164.09

GW170817_injections['ra'] = -0.185539506068 + 2*np.pi*time_offset/(time_sid_day)
